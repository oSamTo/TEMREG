...
species <- "NMVOC" # species to profiles: SET TO NA for generic pollutant representation
...
EMEP4UKprofiles(year=NA, species = c("NMVOC"), classification="SNAP", filetype = "data file", hourly = F, comp_plot = T)
